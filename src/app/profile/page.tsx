        ...
        <>
          ...
          {myEntry.roundScores.length > 0 && (
            <div className="grid grid-cols-2 gap-4">
              {(() => {
                const bestRound = myEntry.roundScores.reduce((a, b) =>
                  a.points > b.points ? a : b
                );
                const worstRound = myEntry.roundScores.reduce((a, b) =>
                  a.points < b.points ? a : b
                );
                const boldestRound = myEntry.roundScores.reduce((a, b) =>
                  a.fedt < b.fedt ? a : b
                );
                const safestRound = myEntry.roundScores.reduce((a, b) =>
                  a.fedt > b.fedt ? a : b
                );
